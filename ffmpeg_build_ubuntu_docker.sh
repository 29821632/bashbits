...
cd nasm-2.13.01
./autogen.sh
PATH="$FFBINDIR:$PATH" ./configure --prefix="$FFBUILDDIR" --bindir="$FFBINDIR"
...
# INSTALL libvpx
# installing from the repository because compiling requires perl which may not be available
